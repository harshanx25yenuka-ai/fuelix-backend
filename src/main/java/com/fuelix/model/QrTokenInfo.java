...
public class QrTokenInfo {
    ...
    public QrTokenInfo(String tokenId, String nonce, Long vehicleId, Long userId, Long ownerId,
                       Instant createdAt, Instant expiresAt, boolean used,
                       String usedBy, Instant usedAt, String tokenType) {
    ...
    public static class Builder {
        ...
        public QrTokenInfo build() {
            return new QrTokenInfo(tokenId, nonce, vehicleId, userId, ownerId, createdAt,
                    expiresAt, used, usedBy, usedAt, tokenType);
        }
    }
